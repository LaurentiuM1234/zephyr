...
#define IMX93_CCM_TYPE_INT_PLL 0x01100000
#define IMX93_CCM_TYPE_FRACN_PLL 0x10000000
...
#define IMX93_CCM_SYS_PLL1_PFD0_DIV2 IMX93_CCM_CLOCK(0, FRACN_PLL)
#define IMX93_CCM_SYS_PLL1_PFD1_DIV2 IMX93_CCM_CLOCK(1, FRACN_PLL)
#define IMX93_CCM_AUDIO_PLL IMX93_CCM_CLOCK(2, FRACN_PLL)

/* clock roots */
#define IMX93_CCM_LPUART1_ROOT IMX93_CCM_CLOCK(0, ROOT)
#define IMX93_CCM_LPUART2_ROOT IMX93_CCM_CLOCK(1, ROOT)
#define IMX93_CCM_LPUART8_ROOT IMX93_CCM_CLOCK(2, ROOT)

/* IP clocks */
#define IMX93_CCM_LPUART1 IMX93_CCM_CLOCK(0, IP)
#define IMX93_CCM_LPUART2 IMX93_CCM_CLOCK(1, IP)
#define IMX93_CCM_LPUART8 IMX93_CCM_CLOCK(2, IP)
